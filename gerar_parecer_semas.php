<div>
    <form class="formulario" id="parecer_form_s" method="post">
        ...
        <div style="display: none; margin-left: 0px" id="dados_notif_01">
            ...
            <input type="text" name="num_notif1" id="nmNot01" style="margin-left: 10px; margin-bottom: 5px;"><br>
            <label style="float:left; margin-bottom: 5px;">Data: </label>
            <input type="date" name="date_notif1" id="dtNot01" style="margin-left: 100px; margin-bottom: 5px;"><br>
            <label style="float:left; margin-bottom: 5px;">Recebimento: </label>
            <input type="date" name="receb_notif1" id="rbNot01" style="margin-left: 50px; margin-bottom: 5px;"><br>
            <label style="float:left; margin-bottom: 5px;">Atendimento: </label>
            <input type="date" name="atend_notif1" id="atNot01" style="margin-left: 50px; margin-bottom: 5px;">
        </div>
        </main>
