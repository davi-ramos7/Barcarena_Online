...
<html lang="pt-br">
	...
	<body>
		<h1>Processos Cadastrados-2021</h1>
		<?php

		$result_procs_21 = "SELECT * FROM lista_de_processos WHERE processo LIKE '%2021%' ORDER BY processo";
		...
		while($x = mysqli_fetch_array($resultado_procs_21)){
