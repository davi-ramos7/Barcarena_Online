...
<html lang="pt-br">
	...
	<body>
		<h1>Processos Cadastrados-2019</h1>
		<?php

		$result_procs_19 = "SELECT * FROM lista_de_processos WHERE processo LIKE '%2019%' ORDER BY processo";
		
		$resultado_procs_19 = mysqli_query($con, $result_procs_19);
